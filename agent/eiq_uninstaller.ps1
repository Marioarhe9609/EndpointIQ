<#
.SYNOPSIS
    EndpointIQ Agent - Desinstalador para Windows
.DESCRIPTION
    Elimina completamente el agente EndpointIQ.
.NOTES
...
Write-Host ""
Write-Host "  +==================================================+"
Write-Host "  |       EndpointIQ Agent - Desinstalador           |"
Write-Host "  +==================================================+"
Write-Host ""
...
Write-Host "  |     EndpointIQ Agent ha sido removido.           |" -ForegroundColor Green
Write-Host "  +==================================================+" -ForegroundColor Green
Write-Host ""
